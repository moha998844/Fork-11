# --- 2. General Kernel & Memory Debugging Overhead ---
...
# --- 3. ARM Coresight Hardware Tracing ---
...
# --- 4. Network & Packet Tracing / Debugging ---
# CONFIG_NET_DEBUG is not set
# CONFIG_NETFILTER_XT_TARGET_TRACE is not set
# CONFIG_MAC80211_DEBUG is not set
# CONFIG_CFG80211_DEVELOPER_WARNINGS is not set
#CONFIG_NET_DROP_MONITOR is not set
# --- 5. Hardware, Peripheral & Driver Diagnostic Logs ---
# CONFIG_USB_DEBUG is not set
# CONFIG_MMC_DEBUG is not set
# CONFIG_POWER_SUPPLY_DEBUG is not set
# CONFIG_SND_DEBUG is not set
# CONFIG_PINCTRL_DEBUG is not set
